module TSOS {
  export class Disk {
    ...
    public static readonly trackSize =
      Disk.sectorCount * Disk.blockCount * Disk.blockSize;
    ...
    public formatDisk(quickFormat: boolean = false, update: boolean = true): void {
      try {
